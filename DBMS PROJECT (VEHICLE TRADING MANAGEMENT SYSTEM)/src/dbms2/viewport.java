...
public class viewport extends javax.swing.JFrame {
    ...
    public viewport() {
        initComponents();
          ...
          try{
                ...
                pst3.setString(1,Dbms2.g_car_id2);
              ...
              // jLabel4.setText(rs3.getString("model_id"));
               jLabel21.setText(rs3.getString("color"));
              // jLabel23.setText(rs3.getString("category"));
               jLabel27.setText(rs3.getString("KM_driven"));
               jLabel19.setText(rs3.getString("transmission"));
               jLabel23.setText(rs3.getString("purchase_date"));
               jLabel29.setText(rs3.getString("amount"));
          ...
          try{
               ...
               if(rs4.next()){
                jLabel3.setText(rs4.getString("company"));
                jLabel5.setText(rs4.getString("model"));
                jLabel11.setText(rs4.getString("version"));
                jLabel31.setText(rs4.getString("category"));
          ...
          try{
               ...
               if(rs5.next()){
                jLabel13.setText(rs5.getString("first_name")+ " " + rs5.getString("last_name"));
                jLabel14.setText(rs5.getString("mobile_no"));
                jLabel16.setText(rs5.getString("city"));
        ...
        //imagecode
          String path="C:\\Users\\Rohan\\Desktop\\New folder (2)\\"+Dbms2.g_car_id2+".jpg";          
         ImageIcon original=new ImageIcon(path);
         Image dabImage=original.getImage();
        
         Image Modified = dabImage.getScaledInstance(280,300,java.awt.Image.SCALE_SMOOTH);
    ...
    private void initComponents() {
        ...
        jLabel1.setPreferredSize(new java.awt.Dimension(300, 360));
        ...
        jLabel13.setPreferredSize(new java.awt.Dimension(380, 30));
        ...
        jLabel22.setText("Purchase date:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query1="INSERT into transaction(buyer,seller,car_id)values(?,?,?)";
            
            try (PreparedStatement pst1 = conn.prepareStatement(query1)) {
                pst1.setString(1,Dbms2.g_user_id);
                pst1.setString(2,temp_person_id);
                pst1.setString(3,Dbms2.g_car_id2);
